...
1. Glorot, Xavier and Bengio, Yoshua (2010). *Understanding the Difficulty of Training Deep Feedforward Neural Networks*. *Proceedings of AISTATS, 9, 249--256*.
2. Dauphin et al. (2014). *Identifying and Attacking the Saddle Point Problem in High-Dimensional Non-Convex Optimization*. *NeurIPS*.
3. Goodfellow, Ian and Bengio, Yoshua and Courville, Aaron (2016). *Deep Learning*. *MIT Press*.
